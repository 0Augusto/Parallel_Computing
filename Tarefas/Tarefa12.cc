 ...
 * Linux:       gcc Tarefa12.cpp -o Tarefa12
 * Windows:     gcc -o Tarefa12.exe   
 * macbook:     gcc -o Tarefa12.cpp  Tarefa12
 ...
 * Tempo Sequencial:
Tempo do while = 0.533218
First Compute Path Time = 0.533300
Tempo do while = 2.169429
Second Compute Path Time = 2.169464
Work hard time = 2.706047

real    0m3.335s
user    0m3.079s
sys     0m0.248s

 * Tempo Paralelo (política default):
 Tempo do while = 0.404788
First Compute Path Time = 0.404839
Tempo do while = 1.662339
Second Compute Path Time = 1.662367
Work hard time = 2.069931

real    0m2.604s
user    0m4.479s
sys     0m0.189s

 * Tempo Paralelo (politica dynamic/static):
Tempo do while = 0.723637
First Compute Path Time = 0.723714
Tempo do while = 2.969296
Second Compute Path Time = 2.969333
Work hard time = 3.695935
...
void fill_travel(vector<Travel>& travels, vector<Flight>& flights, string starting_point, unsigned long t_min, unsigned long t_max){
  /**
   * Função O(n) paralelizavél, como a ordem do vetor não importa, pode ser paralelizado. 
   */
...
bool company_are_in_a_common_alliance(const string& c1, const string& c2, vector<vector<string> >& alliances){
  ...
  /**
   * Possibilidade de paralelizar dois loops aninhados independentes entre si, 
   * portanto, utilizamos o collapse para sequencializar os dois loops.
   */
  //#pragma omp parallel for schedule(dynamic)
...
int Tarefa12(int argc, char **argv) {
